<?php
    ...
    $sql_c="INSERT INTO `DBTECWEB`.`CONYUGE` (`MORRO_Boleta_C`, `APE_PAT_C`, `APE_MAT_C`,`NOM_C`,`FOTO_C`, `CALLE_C`, `NUM_INT_C`, `NUM_EXT_C`, `LUGART_C`, `DOMT_C`, `TELT_C`, `TELC_C`, `RELIGION_C`, `EXT_C`, `CURP_C`, `COLONIA_C`, `MUNICIPIO_C`, `ESTADO_C`, `CP_C`) VALUES ('$folio', '$cony_apellido_pat', '$cony_apellido_mat', '$cony_nombres','default.png', '$cony_calle', '$cony_numInt', '$cony_numExt', '$cony_lugar_trabajo', '$cony_domicilio_trabajo', '$cony_tel_trabajo', '$cony_tel_celular', '$cony_religion', '$cony_extension', '$cony_curp', '$cony_colonia', '$cony_alcaldia', '$cony_entidad', '$cony_cp')";
